export default function Experience() {
  return (
    <>
      ...
      <section
        id="experience"
        className="py-5 max-w-6xl mx-auto bg-gradient-to-b from-background to-background"
      >
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              <h3 className="text-xl font-semibold mb-6 flex items-center gap-3">
                <i className="fas fa-graduation-cap text-foreground"></i>
                Education
              </h3>
              <div className="border-l-4 border-foreground pl-6 space-y-8">
                {/* MMCY Bootcamp */}
                <div className="glass-effect p-6 box">
                  ...
                  <p className="text-secondary-text text-sm">
                    FullStack Development Training in Vue.js and
                    Node.js(Express)
                  </p>
                </div>
